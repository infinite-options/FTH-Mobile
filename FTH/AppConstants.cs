namespace FTH
{
    public static class AppConstants
    {
        ...
        /// </summary>
        public static string NotificationHubName { get; set; } = "M4Me-Notification-Hub";
        ...
        /// </summary>
        public static string ListenConnectionString { get; set; } = "Endpoint=sb://m4me-notification-namespace.servicebus.windows.net/;SharedAccessKeyName=DefaultListenSharedAccessSignature;SharedAccessKey=eph4xeIx8aT5WjE9rLu561zutM5BTdE2JPaa/SHHTM8=";
        /// <summary>
        /// Tag used in log messages to easily filter the device log
        /// during development.
        /// </summary>
        public static string DebugTag { get; set; } = "M4Me";
