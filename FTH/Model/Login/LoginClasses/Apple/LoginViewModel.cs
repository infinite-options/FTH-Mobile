...
using FTH.Model.SignUp;
using FTH.Model.User;
            ...
            try
            {
                ...
                if (account != null)
                {
                    ...
                    else
                    {
                        ...
                        Debug.WriteLine("socialLoginpostserialized: " + socialLogInPostSerialized);
        ...
        public async void AppleUserProfileAsync(string appleId, string appleToken, string appleUserEmail, string userName)
        {
            ...
            if (RDSResponse.IsSuccessStatusCode)
            {
                if (responseContent != null)
                {
                    ...
                    {
                        var signUp = await Application.Current.MainPage.DisplayAlert("Message", "It looks like you don't have a FTH account. Please sign up!", "OK", "Cancel");
                        if (signUp)
                        {
                    ...
                    {
                        await Application.Current.MainPage.DisplayAlert("Oops!", "You have an existing FTH account. Please use direct login", "OK");
                    }
                }
            }
        }
