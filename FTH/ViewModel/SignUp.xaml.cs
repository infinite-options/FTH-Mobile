...
namespace FTH.ViewModel
{
    ...
    public partial class SignUp : ContentPage
    {
        ...
        void checkPlatform()
        {
            seePassword1.CornerRadius = 14;
            seePassword2.CornerRadius = 14;
        }
        ...
        void clickedSeePassword1(System.Object sender, System.EventArgs e)
        {
            ...
            else newPassword.IsPassword = true;
        }

        void clickedSeePassword2(System.Object sender, System.EventArgs e)
        {
            if (retypePassword.IsPassword == true)
                retypePassword.IsPassword = false;
            else retypePassword.IsPassword = true;
        }
